...
/*   Updated: 2023/01/31 02:01:00 by sdk-meb          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
template < class Container >
	class BST : protected ___abase <Container> {
...
/***************************  @category	 __  constructor  __  ***********************************************/
		...
		BST (const key_compare& cmp, Allocator alloc = Allocator()) : ___abase <Container> (cmp, alloc) { }
...
/***************************  @category	 __  BST #  node deletion tree  __  *********************************/
	...
	*********************************************************************************************************/
		__road&		insertion(__road& _node, __road* sub, bool ex=true) {
			...
			if (t_comp (*_node.Ship, *sub->Ship, this->k_comp)) {
			...
			else if (t_comp (*sub->Ship, *_node.Ship, this->k_comp)) {
