...
int main() {
    ...
    std::cout << "\033[36m" << "************************************ test 0 < constructors , iterators > ************************************ " << "\033[0m" << std::endl;
    {
        ...
        try
        {
            ...
            _ft::map<std::string, int> m2(m1.begin(), m1.end());
            _ft::map<std::string, int> m3(m1);

            std::cout << "*********** m1 < normal > ************" << std::endl;
            for (_ft::map<std::string, int>::iterator it = m1.begin() ; it != m1.end(); it++)
                std::cout << "\n" << it->first << "\t" << (*it).second;
            std::cout << std::endl;

            std::cout << "*********** m1 < reverse > ************" << std::endl;
            for (_ft::map<std::string, int>::reverse_iterator it = m1.rbegin() ; it != m1.rend(); it++)
                std::cout << "\n" << it->first << "\t" << it->second;
            std::cout << std::endl;

            std::cout << "*********** m2 < normal > ************" << std::endl;
            for (_ft::map<std::string, int>::iterator it = m2.begin() ; it != m2.end(); it++)
                std::cout << "\n" << it->first << "\t" << it->second;
            std::cout << std::endl;

            std::cout << "*********** m2 < reverse > ************" << std::endl;
            for (_ft::map<std::string, int>::reverse_iterator it = m2.rbegin() ; it != m2.rend(); it++)
                std::cout << "\n" << it->first << "\t" << it->second;
            std::cout << std::endl;

            std::cout << "*********** m3 < normal > ************" << std::endl;
            for (_ft::map<std::string, int>::iterator it = m3.begin() ; it != m3.end(); it++)
                std::cout << "\n" << it->first << "\t" << it->second;
            std::cout << std::endl;

            std::cout << "*********** m3 < reverse > ************" << std::endl;
            for (_ft::map<std::string, int>::reverse_iterator it = m3.rbegin() ; it != m3.rend(); it++)
                std::cout << "\n" << it->first << "\t" << it->second;
            std::cout << std::endl;
        }
        catch(const std::exception& e)
    ...
    std::cout << std::endl << "\033[36m" << "************************************ test 1 < empty , size , max_size > ************************************ " << "\033[0m" << std::endl;
    {
        ...
        try
        {
            _ft::map<std::string, int> m1;
            _ft::map<int , int> m2;
            _ft::map<std::string , std::string> m3;
    ...
    std::cout << std::endl << "\033[36m" << "************************************ test 2 < insert > ************************************ " << "\033[0m" << std::endl;
    {
        ...
        {
            _ft::map<std::string, int> m1;
            _ft::pair<_ft::map<std::string, int>::iterator, bool> p;

            p = m1.insert(_ft::make_pair("a", 1));
            std::cout << std::boolalpha;
            std::cout << "insert a : " << "[ " << p.first->first << " , " << p.first->second << " ] | Added : "<< p.second << std::endl;
            p = m1.insert(_ft::make_pair("a", 1));
            std::cout << "insert a : " << "[ " << p.first->first << " , " << p.first->second << " ] | Added : "<< p.second << std::endl;
            ...
            p = m1.insert(_ft::make_pair("b", 2));
            std::cout << "insert b : " << "[ " << p.first->first << " , " << p.first->second << " ] | Added : " << p.second << std::endl;
            p = m1.insert(_ft::make_pair("b", 2));
            std::cout << "insert b : " << "[ " << p.first->first << " , " << p.first->second << " ] | Added : " << p.second << std::endl;
            std::cout << "m1 size : " << m1.size() << std::endl;

            _ft::map<std::string, int> m2;
            _ft::map<std::string, int>::iterator it;
            m2["a"] = 1;
            m2["b"] = 2;
            m2["d"] = 4;
            m2["e"] = 5;
            ...
            m2["h"] = 8;
            std::cout << "*********** m2 before ************" << std::endl;
            for (_ft::map<std::string, int>::iterator it2 = m2.begin() ; it2 != m2.end(); it2++)
                std::cout << "\n" << it2->first << "\t" << it2->second;
            std::cout << std::endl;

            it = m2.insert(m2.begin(), _ft::make_pair("c", 3));
            std::cout << "*********** m2 after ************" << std::endl;
            for (_ft::map<std::string, int>::iterator it2 = m2.begin() ; it2 != m2.end(); it2++)
                std::cout << "\n" << it2->first << "\t" << it2->second;
            std::cout << std::endl;
            ...
            _ft::map<std::string, int> m3;
            m3["a"] = 1;
            m3["b"] = 2;

            std::cout << "*********** m3 before ************" << std::endl;
            for (_ft::map<std::string, int>::iterator it2 = m3.begin() ; it2 != m3.end(); it2++)
                std::cout << "\n" << it2->first << "\t" << it2->second;
            std::cout << std::endl;
            std::cout << "m3 size : " << m3.size() << std::endl;
    ...
    std::cout << std::endl << "\033[36m" << "************************************ test 3 < erase > ************************************ " << "\033[0m" << std::endl;
    {
        ...
        try
        {
            ...
            m1["f"] = 6;
            std::cout << "*********** m1 before ************" << std::endl;
            for (_ft::map<std::string, int>::iterator it2 = m1.begin() ; it2 != m1.end(); it2++)
                std::cout << "\n" << it2->first << "\t" << it2->second;
            std::cout << std::endl;
            std::cout << "m1 size : " << m1.size() << std::endl;
            m1.erase(m1.begin());
    ...
    std::cout << std::endl << "\033[36m" << "************************************ test 4 < swap > ************************************ " << "\033[0m" << std::endl;
    {
        ...
        try
        {
            ...
            std::cout << "foo contains:\n";
            for (_ft::map<char,int>::iterator it=foo.begin(); it!=foo.end(); ++it)
                std::cout << it->first << " => " << it->second << '\n';
            std::cout << "foo size : " << foo.size() << std::endl;

            std::cout << "bar contains:\n";
            for (_ft::map<char,int>::iterator it=bar.begin(); it!=bar.end(); ++it)
                std::cout << it->first << " => " << it->second << '\n';
            std::cout << "bar size : " << bar.size() << std::endl;
    ...
    std::cout << std::endl << "\033[36m" << "************************************ test 5 < clear > ************************************ " << "\033[0m" << std::endl;
    {
        ...
        try
        {
            ...
            std::cout << "m1 contains:\n";
            for (_ft::map<char,int>::iterator it=m1.begin(); it!=m1.end(); ++it)
                std::cout << it->first << " => " << it->second << '\n';
            std::cout << "m1 size : " << m1.size() << std::endl;
        ...
        {
            {
                ...
                _ft::map<char,int>::key_compare _comp = m1.key_comp();
                ...
                _ft::map<char,int>::iterator it = m1.begin();
                do {
                    std::cout << it->first << " => " << it->second << '\n';
                } while ( _comp((*it++).first, highest) );
...

            {
                ...
                _ft::pair<char,int> highest = *m2.rbegin();          // last element

                _ft::map<char,int>::iterator it = m2.begin();
                do {
                    std::cout << it->first << " => " << it->second << '\n';
                } while ( m2.value_comp()(*it++, highest) );
            }
    ...
    std::cout << std::endl << "\033[36m" << "************************************ test 9 < lower_bound , upper_bound , equal_range > ************************************ " << "\033[0m" << std::endl;
    {
        ...
        {
            _ft::map<char,int> m1;
            _ft::map<char,int>::iterator low,up;
            ...
            _ft::pair<_ft::map<char,int>::iterator,_ft::map<char,int>::iterator> ret;
            ret = m2.equal_range('b');
